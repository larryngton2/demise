...
public class CustomSkin extends Module {
    ...
    public final ModeValue skinMode = new ModeValue("Skin", new String[] {"❤", "larryngton", "Michael Ernst", "izuna", "GommeHD", "Ye"}, "larryngton", this, () -> !customUrl.get());
    ...
    public String getURL() {
        if (!customUrl.get()) {
            return switch (skinMode.get()) {
                ...
                case "Michael Ernst" -> "https://s.namemc.com/i/c6e0ab215c046d63.png";
