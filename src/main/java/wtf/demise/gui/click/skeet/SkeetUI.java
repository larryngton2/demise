package wtf.demise.gui.click.skeet;
...
import wtf.demise.gui.click.skeet.component.TabComponent;
import wtf.demise.gui.click.skeet.component.impl.GroupBoxComponent;
import wtf.demise.gui.click.skeet.component.impl.sub.checkBox.CheckBoxTextComponent;
import wtf.demise.gui.click.skeet.component.impl.sub.color.ColorPickerTextComponent;
import wtf.demise.gui.click.skeet.component.impl.sub.comboBox.ComboBoxTextComponent;
import wtf.demise.gui.click.skeet.component.impl.sub.comboBox2.ComboBox2TextComponent;
import wtf.demise.gui.click.skeet.component.impl.sub.key.KeyBindComponent;
import wtf.demise.gui.click.skeet.component.impl.sub.slider.SliderTextComponent;
import wtf.demise.gui.click.skeet.component.impl.sub.text.box.StringTextComponent;
    ...
    public SkeetUI() {
        this.rootComponent = new Component(null, 0.0f, 0.0f, 370, 350.0f) {
            ...
            public void drawComponent(final LockedResolution lockedResolution, final int mouseX, final int mouseY) {
                ...
                ++hue;
                if (Demise.INSTANCE.getModuleManager().getModule(ClickGUI.class).rainbow.get()) {
        ...
        for (ModuleCategory category : ModuleCategory.values()) {
            final TabComponent categoryTab = new TabComponent(this.rootComponent, StringUtils.upperSnakeCaseToPascal(category.name()), 51.5f, 5.0f, 315.0f, 341.5f) {
                ...
                public void setupChildren() {
                    final List<Module> modulesInCategory = Demise.INSTANCE.getModuleManager().getModulesByCategory(category);
