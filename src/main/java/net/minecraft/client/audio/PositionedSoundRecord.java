...
public class PositionedSoundRecord extends PositionedSound {
    ...
    private PositionedSoundRecord(ResourceLocation soundResource, float volume, float pitch, AttenuationType attenuationType, float xPosition, float yPosition, float zPosition) {
        super(soundResource);
        this.volume = volume;
        this.pitch = pitch;
