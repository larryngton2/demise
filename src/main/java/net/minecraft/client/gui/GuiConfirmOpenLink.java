...
public class GuiConfirmOpenLink extends GuiYesNo {
    ...
    public void initGui() {
        ...
        this.buttonList.add(new GuiButton(0, (float) width / 2 - 50 - 105, (float) height / 6 + 96, 100, 20, this.confirmButtonText));
        this.buttonList.add(new GuiButton(2, (float) width / 2 - 50, (float) height / 6 + 96, 100, 20, this.copyLinkButtonText));
        this.buttonList.add(new GuiButton(1, (float) width / 2 - 50 + 105, (float) height / 6 + 96, 100, 20, this.cancelButtonText));
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.showSecurityWarning) {
            drawCenteredString(this.fontRendererObj, this.openLinkWarning, (float) width / 2, 110, 16764108);
        }
    }
