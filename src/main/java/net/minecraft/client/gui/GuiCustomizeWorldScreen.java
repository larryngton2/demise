...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
    ...
    private void func_175325_f() {
        ...
        this.field_175349_r = new GuiPageButtonList(mc, width, height, 32, height - 32, 25, this, aguipagebuttonlist$guilistentry, aguipagebuttonlist$guilistentry1, aguipagebuttonlist$guilistentry2, aguipagebuttonlist$guilistentry3);
        ...
        if (button.enabled) {
            switch (button.id) {
                case 300:
                    ...
                    mc.displayGuiScreen(this.field_175343_i);
                    break;
