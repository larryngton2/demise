...
public abstract class GuiContainer extends GuiScreen {
    ...
    public void initGui() {
        super.initGui();
        mc.thePlayer.openContainer = this.inventorySlots;
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        for (int i1 = 0; i1 < this.inventorySlots.inventorySlots.size(); ++i1) {
            ...
            if ((this.isMouseOverSlot(slot, mouseX, mouseY) || (manager.isEnabled() && manager.slot == i1 && this instanceof GuiInventory) || (stealer.isEnabled() && stealer.slot == i1 && this instanceof GuiChest)) && slot.canBeHovered()) {
                this.theSlot = slot;
                GlStateManager.disableLighting();
                GlStateManager.disableDepth();
        ...
        if (mouseButton == 0) {
            for (GuiButton guibutton : this.buttonList) {
                if (guibutton.mousePressed(mc, mouseX, mouseY)) {
                    ...
                    switch (guibutton.id) {
                        case 1001:
                            final KillAura killAura = Demise.INSTANCE.getModuleManager().getModule(KillAura.class);
            ...
            if (isShiftKeyDown()) {
                if (slot.inventory != null && this.shiftClickedSlot != null) {
                    for (Slot slot2 : this.inventorySlots.inventorySlots) {
                        if (slot2 != null && slot2.canTakeStack(mc.thePlayer) && slot2.getHasStack() && slot2.inventory == slot.inventory && Container.canAddItemToSlot(slot2, this.shiftClickedSlot, true)) {
    ...
    protected void handleMouseClick(Slot slotIn, int slotId, int clickedButton, int clickType) {
        ...
        mc.playerController.windowClick(this.inventorySlots.windowId, slotId, clickedButton, clickType, mc.thePlayer);
    }
    ...
    public void onGuiClosed() {
        if (mc.thePlayer != null) {
            this.inventorySlots.onContainerClosed(mc.thePlayer);
        }
    }
